 ...
 * Plugin URI:        https://draftpress.com/
 * Description:        Limit the number of posts or custom post types that can be published based on role (i.e, author) or user. For detailed documentation, please visit the plugin's <a href="https://draftpress.com/"> official page</a>.
 * Version:            2.1.0
 * Author:            99 Robots
